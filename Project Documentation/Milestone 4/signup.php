...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($user_name) && !empty($password) && !is_numeric($user_name))
		{
			...
			//changed user to defaultuser
			$query = "insert into defaultuser (user_id,user_name,password) values ('$user_id','$user_name','$passwordHash')";
		...
		<div class="container-login100" style="background-image: url('images/red.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form">
					...
					<a href="login.php" class="txt2">Click to Login</a><br><br>
						</a>
