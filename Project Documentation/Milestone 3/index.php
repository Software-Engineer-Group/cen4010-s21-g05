...
<body>
	...
	<div class="center">
	<br><h2>Welcome back, <?php echo $user_data['user_name']; ?>!</h2>
	</div>

	<br><img class="center"src="images/uc.png" alt="Image"><br><br>
...
<div class="panel">
    ...
    <div class="media-block pad-all">
      ...
      <div class="media-body">
        ...
        <img class="img-responsive thumbnail" src="images/greys.jpeg" alt="Image">
        <div class="pad-ver">
